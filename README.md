...
以下截图来自本地运行中的首页，展示动态 3D 太阳系 Hero、轨道行星、科幻 HUD 和手势探索入口：

![太阳系 3D 科普网站首页宣传截图](./docs/solar-home-promo.png)
...
- AI 手势控制：支持摄像头手势模式和无摄像头演示模式，可用虚拟光标、捏合、挥手、双指缩放和握拳爆炸操控 3D 星图。
...
- [AI 手势控制太阳系功能设计方案](./docs/gesture-control-design.md)：说明视觉手势如何替代鼠标、捏合如何选择行星、握拳如何触发 3D 粒子爆炸、手势 HUD 如何呈现，以及前端组件拆分和性能降级方案。
